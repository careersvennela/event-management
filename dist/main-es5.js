...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _pages_event_list_events_list_events_component__WEBPACK_IMPORTED_MODULE_5__["ListEventsComponent"], _pages_event_book_event_book_event_component__WEBPACK_IMPORTED_MODULE_6__["BookEventComponent"], _list_filter_pipe__WEBPACK_IMPORTED_MODULE_11__["ListFilterPipe"]],
  ...
  function srcAppEventsServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var EventsService = /*#__PURE__*/function () {
      function EventsService(http) {
        ...
        this.http = http;
        this.serverUrl = "/";
        this.getEventsList().subscribe(function (data) {
          console.log(data);
        });
      }
    ...
    var BookEventComponent = /*#__PURE__*/function () {
      ...
      _createClass(BookEventComponent, [{
        ...
        value: function submit(success, error) {
          ...
          this.eventService.postApi('book-event', this.bookEventForm.value).subscribe(function (res) {
            if (res.success) {
    ...
    var ListEventsComponent = /*#__PURE__*/function () {
      ...
      _createClass(ListEventsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.eventService.getApi('getAllBookings').subscribe(function (res) {
            if (res.success) {
              _this3.bookings = res.data;

              _this3.bookings.forEach(function (element) {
                console.log(element);

                if (_this3.eventBookings[element.eventId]) {
                  _this3.eventBookings[element.eventId] = _this3.eventBookings[element.eventId] + element.noOfSeats;
                } else {
                  _this3.eventBookings[element.eventId] = element.noOfSeats;
                }
              });

              console.log(_this3.eventBookings);
            }
          });
        }
      }, {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\anush\Downloads\Interview-Full-stack\Interview-Full-stack\final-code\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
